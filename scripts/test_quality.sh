python scripts/cal_quality.py --dir1  "/flashps_data/standard_img_flux/" --dir2 "/flashps_data/flux_use_kv/" --dir3 "/flashps_data/flux_teacache/" --name1 "flashps" --name2 "teacache" --prompt_type "flux" --prompt_folder "/flashps_data/flux_prompts/" --model_name "Flux" && \
...
python scripts/cal_quality.py --dir1 "/flashps_data/ootd_standard/" --dir2 "/flashps_data/ootd_use_o/" --dir3 "/flashps_data/ootd_teacache/" --name1 "flashps" --name2 "teacache"  --model_name "OOTD" && \
...
python scripts/cal_quality.py --dir1 "/flashps_data/sd2_standard/" --dir2  "/flashps_data/sd2_use_kv/"  --dir3 "/flashps_data/sd2_fisedit/" --name1 "flashps" --name2 "fisedit" --prompt_type "sd2" --prompt_folder  "/flashps_data/sd2_prompts" --model_name "sd2" && \
