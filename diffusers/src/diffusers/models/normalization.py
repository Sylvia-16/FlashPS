    ...
    def forward(
        ...
        if x.ndim == 2:
            ...
            if indices is not None:
                shift_msa = shift_msa[indices]
                scale_msa = scale_msa[indices]
                gate_msa = gate_msa[indices]
                shift_mlp = shift_mlp[indices]
                scale_mlp = scale_mlp[indices]
                gate_mlp = gate_mlp[indices]
            # We keep gate_msa as is - it will be correctly expanded in the calling code
        else:
        ...
        result = normalized_x * (1 + scale_msa) + shift_msa
        return result, gate_msa, shift_mlp, scale_mlp, gate_mlp
